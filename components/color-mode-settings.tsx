        ...
        <Tabs defaultValue="mode" className="mt-4">
          ...
          <TabsContent value="mode" className="space-y-4">
            <div className="space-y-4">
              <RadioGroup value={colorMode} onValueChange={(value) => onChangeColorMode(value as ColorMode)}>
          ...
          <TabsContent value="display" className="space-y-4">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch id="show-tailwind" checked={showTailwindClasses} onCheckedChange={onToggleTailwindClasses} />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch id="show-material" checked={showMaterialNames} onCheckedChange={onToggleMaterialNames} />
              </div>
            </div>
          </TabsContent>
        </Tabs>
